...
**Status:** implemented in WinTAK 5.6 as of 2.12.2. Not yet implemented in ATAK, CloudTAK or
...
and the mismatch is fatal. Packages built before 2.12.2 carry the wrong declaration and should be
rebuilt.
